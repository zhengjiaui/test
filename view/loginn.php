...
<div class="title0">越野机车管理平台</div>
<div class="title1">好玩.有趣</div>
<div class="imgGroug">
<ul>
...
<h2>登录</h2><p class="tyg-p">欢迎访问  越野机车</p>
<div style="margin:5px 0px;">
<input type="text" name='admin' placeholder="请输入账号..."/>
</div>
<div style="margin:5px 0px;">
<input type="password" name='pwd' placeholder="请输入密码..."/>
</div>
<div style="margin:5px 0px;">
<input type="text" name='yanzheng' style="width:150px;" placeholder="请输入验证码..."/>
<img src="tool/validation.php" style="vertical-align:bottom;" alt="验证码"/>
</div>
