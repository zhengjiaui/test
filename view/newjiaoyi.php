...
<body>
<h2>添加物品界面</h2>
<form method='post' action='index.php?c=Jiaoyi&action=endgood' enctype="multipart/form-data">
<span>物品名称：</span><input required='required' type='text' name='gname' /><br/><br/>
...
<span>属性类型：</span><select name='type'>  
